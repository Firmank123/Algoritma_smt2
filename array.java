...
public class array {
    ...
    "Masukkan Nilai Angka untuk MK Konsep Teknolgi Informasi", 
    "Masukkan Nilai Angka untuk MK Critical Thinking dan Problem Solving", 
    "Masukkan Nilai Angka untuk MK Matematika Dasar", 
    "Masukkan Nilai Angka untuk MK Bahasa Inggris", 
    "Masukkan Nilai Angka untuk MK Dasar Pemrograman", 
    "Masukkan Nilai Angka untuk MK Praktikum Dasar Pemrograman", 
    "Masukkan Nilai Angka untuk MK Kesehatan dan Keselamatan Kerja"};
    int[] nilai = new int[8];
    ...
    void hasil() {
        ...
        System.out.printf("Critical Thinking dan Problem Solving     %d                           %s                         %.2f\n", nilai[2], nHuruf[2], bNilai[2]);
